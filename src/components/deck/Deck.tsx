            ...
            <div className="flex flex-col justify-center">
                <div className="flex justify-center flex-row-reverse">
                    {(cards as UnoCard[]).map((card, i) => (
                        ...
                        <div
                            className={`play-card transition-all ease-in duration-300 bottom-0 relative w-44 -mx-12 overflow-hidden ${isTurn ? 'hover:bottom-5 cursor-pointer' : ''}`}
                            style={{
